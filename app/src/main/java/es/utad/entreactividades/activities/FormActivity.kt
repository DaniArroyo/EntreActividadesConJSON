...
class FormActivity : AppCompatActivity() {
    ...
    fun onActualizar(view: View) {
        ...
        var nombreFichero = "registros.json"
    ...
    private fun leer(): String {
        ...
        try {
            var bufferedReader = BufferedReader(InputStreamReader(openFileInput("registros.json")))
            var contenido: String? = null
            while ({ contenido = bufferedReader.readLine(); contenido }() != null) {
